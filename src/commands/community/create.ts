...
export class CommunityCreateCommand extends SfCommand<CommunityCreateResponse> {
  ...
  public static readonly flags = {
    ...
    'template-name': Flags.string({
      char: 't',
      summary: messages.getMessage('flags.templateName.description'),
      description: messages.getMessage('flags.templateName.longDescription'),
      required: true,
      aliases: ['templatename'],
    }),
    'url-path-prefix': Flags.string({
      char: 'p',
      summary: messages.getMessage('flags.urlPathPrefix.description'),
      description: messages.getMessage('flags.urlPathPrefix.longDescription'),
      required: true,
      aliases: ['urlpathprefix'],
    }),
    description: Flags.string({
      char: 'd',
      summary: messages.getMessage('flags.description.description'),
      description: messages.getMessage('flags.description.longDescription'),
    }),
